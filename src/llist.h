...
extern void *llist_find(struct llist *llist, void *data,
			int (*cmpfn)(void *, void *));
extern void *llist_delete(struct llist *llist, void *data,
			  int (*cmpfn)(void *, void *));
extern int llist_count(struct llist *llist);
extern void llist_foreach(struct llist *llist, void (*f)(void *, void *),
			  void *arg);
